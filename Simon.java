...
public class Simon extends JPanel implements ActionListener, MouseListener {
    ...
    private static final Color BACKGROUND_COLOR = new Color(28, 28, 28);
    private static final Color SIMON_MAGENTA = new Color(141, 43, 195);

    // LOGO:
    private static final int LOGO_Y_LOCATION = 20;
    private static final String LOGO_PATH = "C:\\Users\\Owner\\Desktop\\simon\\src\\images\\logo.png";
    ...
    private void startPattern() {
    	JustGeneratePattern generate = new JustGeneratePattern();
        pattern = new Pattern(scoreBoard.getLevel());
        generate.createPattern(scoreBoard.getLevel());
        gamePatternIndex = 0;
